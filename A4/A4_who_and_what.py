...
aman = Partner("Arya", "Aman", "aarya22")
ken = Partner("Lo", "Ken", "thlo")
team = [aman, ken]

problem1 = Problem("Solving Relationships", 'wicked', "person")
 # In this case, the Python file for the formulation would be named End_Poverty.py.

problems = [problem1]

our_submission = Who_and_what([aman, ken], OPTION_A, problems)
